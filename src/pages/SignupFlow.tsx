  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div id="signup-section" className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          {/* Left Column - Form */}
          ...
          {/* Right Column - AI Assistant Preview (for larger screens) */}
          <div className="hidden lg:block">
            <div className="sticky top-8">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border-0">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Bot className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    Your AI Assistant Preview
                  </h3>
                  <p className="text-sm text-gray-600">
                    See how patients will interact with your practice
                  </p>
                </div>

                {/* Mock chat interface */}
                <div className="space-y-4 bg-gray-50 rounded-lg p-4 min-h-64">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-white rounded-lg p-3 shadow-sm flex-1">
                      <p className="text-sm text-gray-800">
                        Hi! I'm your AI dental assistant. I can help with questions about services, insurance, and scheduling. What can I help you with today?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-white rounded-lg p-3 shadow-sm flex-1">
                      <p className="text-sm text-gray-800">
                        Yes! We accept most major insurance plans including Delta Dental, Cigna, and Aetna. I can help you verify your specific coverage if you'd like.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-xs text-gray-600">Questions Handled</div>
                  </div>
